...

{
    ...
    'data': [
        ...
        'wizard/inventory_report_penerimaan_ktanjung_wizard_view.xml',
        'wizard/inventory_report_penerimaan_ktanjung_wizard_preview_view.xml',
        'wizard/inventory_report_pengeluaran_ktanjung_wizard_view.xml',
        'wizard/inventory_report_pengeluaran_ktanjung_wizard_preview_view.xml',
        'wizard/inventory_report_mutasi_ktanjung_wizard_view.xml',
        'wizard/inventory_report_mutasi_ktanjung_wizard_preview_view.xml',
        'wizard/posisi_barang_per_dokumen_ktanjung_wizard_view.xml',
        'wizard/posisi_barang_per_dokumen_ktanjung_wizard_preview_view.xml',
        'wizard/posisi_stok_barang_ktanjung_wizard_view.xml',
        'wizard/posisi_stok_barang_ktanjung_wizard_preview_view.xml',
        'wizard/aktivitas_importir_ktanjung_wizard_view.xml',
        'wizard/aktivitas_importir_ktanjung_wizard_preview_view.xml',
