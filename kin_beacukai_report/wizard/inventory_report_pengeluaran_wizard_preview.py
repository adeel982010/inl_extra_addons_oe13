...
class InventoryPreviewPengeluaranReportWizard(models.TransientModel):
    ...
    location_ids = fields.Many2many('stock.location', 'ms_stock_card_out_locaton_rel', 'stock_card_id',
                                    'location_id', 'Lokasi', copy=False, domain=[('usage', '=', 'internal')])
    categ_ids = fields.Many2many('product.category', 'ms_stock_card_out_categ_rel', 'stock_card_id',
    ...
    export_report = fields.Selection([('BC 2.5', 'BC 2.5'), ('BC 2.6.1', 'BC 2.6.1'), ('BC 2.7', 'BC 2.7'), (
        'BC 3.0', 'BC 3.0'), ('BC 3.3', 'BC 3.3'), ('BC 4.1', 'BC 4.1')], "Report Type", default='')
    ...
    def get_result(self):
        ...
        query = """
                ...
                WHERE sm.state = 'done' 
                AND ((sm.location_id = '8' AND sm.location_dest_id != '8')
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('kin_beacukai_report.report_inventory_pengeluaran').report_action(self)
