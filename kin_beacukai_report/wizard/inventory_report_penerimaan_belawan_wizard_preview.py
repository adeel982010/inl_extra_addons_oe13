...
class InventoryPreviewPenerimaanBelawanReportWizard(models.TransientModel):
    _inherit = 'inventory.export.penerimaan.belawan.report.wizard'
    ...
    export_report = fields.Selection([('BC 1.6', 'BC 1.6'), ('BC 2.3', 'BC 2.3'), ('BC 2.6.2', 'BC 2.6.2'), (
        'BC 2.7', 'BC 2.7'), ('BC 4.0', 'BC 4.0')], "Report Type", default='BC 4.0')
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('kin_beacukai_report.report_inventory_penerimaan_belawan').report_action(self)
