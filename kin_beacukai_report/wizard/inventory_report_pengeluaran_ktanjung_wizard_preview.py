...
class InventoryPreviewPengeluaranKtanjungReportWizard(models.TransientModel):
    _inherit = 'inventory.export.pengeluaran.ktanjung.report.wizard'
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('kin_beacukai_report.report_inventory_pengeluaran_ktanjung').report_action(self)
